...
export const MEALS_BY_MODE: Record<string, Record<MealType, MealDef>> = {
  "0": {
    breakfast: {
      ...
      steps: ["Разморозьте 100 г ягод — 1 минута в микроволновке, или дайте оттаять.", "Смешайте 300 г йогурта со 100 г ягод и 30 г гранолы в миске."]
    },
    lunch: {
      ...
      ingredients: [{ name: "Курица-гриль готовая", qty: "300 г" }, { name: "Греч. йогурт", qty: "1 шт (150 г)" }, { name: "Огурцы", qty: "2 шт (200 г)" }, { name: "Хлебцы", qty: "1 уп. (30 г)" }],
      steps: ["300 г курицы можно есть холодной или разогреть 1–2 минуты в микроволновке.", "2 огурца (200 г) ополосните и нарежьте дольками.", "Выложите курицу, йогурт (150 г), огурцы и хлебцы (30 г) на тарелку — готово."]
    },
    snack: {
      title: "Протеиновый батончик и яблоко",
      desc: "Готовка не нужна вообще",
      calories: 220, protein: 20, fat: 8, carbs: 22,
      ingredients: [{ name: "Протеиновый батончик", qty: "1 шт (60 г)" }, { name: "Яблоко", qty: "1 шт (180 г)" }],
      steps: ["Просто съешьте батончик (60 г) и яблоко (180 г) — готовить не нужно."]
    },
    dinner: {
      title: "Тарелка с индейкой и овощами",
      desc: "Готовая нарезка индейки, свежие овощи, хумус",
      calories: 430, protein: 40, fat: 16, carbs: 28,
      ingredients: [{ name: "Индейка нарезка готовая", qty: "200 г" }, { name: "Овощи свежие", qty: "200 г" }, { name: "Хумус", qty: "3 ст.л. (45 г)" }],
      steps: ["Выложите 200 г нарезки индейки и 200 г овощей на тарелку.", "Добавьте 3 ст.л. (45 г) хумуса в качестве соуса."]
    }
  },
  "5": {
    breakfast: {
