...
Числа — целые. Сумма КБЖУ по компонентам должна давать реалистичный итог для всего блюда. Если на фото не еда или распознать невозможно, верни {"error": "короткое объяснение по-русски"}.`;
